  ...
  return (
    <Popover open={isDockOpen} onOpenChange={toggleDock}>
      ...
      <PopoverTrigger asChild>
        <Button
          className={`fixed bottom-[100px] right-6 w-[60px] h-[60px] rounded-full p-2 z-[100] bg-blue-600 hover:bg-blue-700 text-white transition-all duration-300 ease-in-out ${isListening ? "animate-pulse-ring" : ""
            }`}
